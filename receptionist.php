...
if(isset($_REQUEST["submit"])){
  ...
  $ins = "INSERT INTO members(id,name,date,address,phone) VALUES('$id','$name','$date','$address','$phone')";
...
<body>
 ...
 <nav class ="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="admin-login.php"><img src="img/iFitness.png" alt="iFitness"></a>
